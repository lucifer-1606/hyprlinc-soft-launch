        ...
        <div>
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-500 text-white py-2 rounded-lg font-medium hover:opacity-90 transition-all duration-200 shadow-md"
              >
                Send Message →
              </button>
            </form>
